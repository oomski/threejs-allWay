...
const allWayGlb = await gltfLoader.loadAsync(
  `${import.meta.env.BASE_URL}Day 35 - All - Way Corner Store SIGN.glb`
);
const allWay = allWayGlb.scene;
...
function animate() {
  ...
  if (isRotating) {
    ...
    // keep rotation value bounded to avoid huge numbers over long runs
